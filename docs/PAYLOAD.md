...
However, if you want to use the mixed payload, you can make it so the values in your `data` payload is passed to the app when tapping the notification by adding `"click_action": "org.apache.cordova.push.background.MESSAGING_EVENT"` to your `notification` payload.
...
```json
{
  "notification": {
    ...
    "body": "This offer expires at 11:30 or whatever",
    "notId": 10,
    "click_action": "org.apache.cordova.push.background.MESSAGING_EVENT"
  },
  "data": {
     "surveyID": "ewtawgreg-gragrag-rgarhthgbad"
  }

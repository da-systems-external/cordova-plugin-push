...
public class PushPlugin extends CordovaPlugin implements PushConstants {
    ...
    private void createChannel(JSONObject channel) throws JSONException {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (SOUND_RINGTONE.equals(sound)) {
                ...
                Uri soundUri = Uri
                        .parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + packageName + "/raw/" + sound);
        ...
        if (INITIALIZE.equals(action)) {
            cordova.getThreadPool().execute(new Runnable() {
                public void run() {
                    ...
                    SharedPreferences sharedPref = getApplicationContext().getSharedPreferences(ORG_APACHE_CORDOVA_PUSH,
    ...
    public void onPause(boolean multitasking) {
        ...
        SharedPreferences prefs = getApplicationContext().getSharedPreferences(ORG_APACHE_CORDOVA_PUSH,
                Context.MODE_PRIVATE);

...
// Project: https://github.com/da-systems-external/cordova-plugin-push
...
declare namespace PhonegapPluginPush {
	...
	interface InitOptions {
		...
		ios?: {
			 ...
			 * Action Buttons on iOS - https://github.com/da-systems-external/cordova-plugin-push/blob/master/docs/PAYLOAD.md#action-buttons-1
			 */
